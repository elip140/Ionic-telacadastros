...
export class PessoaService {
  ...
  GetPessoaTelefone(id: number): Telefone {
    ...
    var Telefone = { pessoaId: id, tipo: TIPOS[Random(0, 2)], ddd: Random(10, 99).toString(), telefone: Random(1000000, 9999999).toString() };
    return Telefone;
  }
  async GetPessoaTelefones(id: string): Promise<Telefone[]> {
    var telefones = new Array<Telefone>;

    this.http.MeusTelefones(id).subscribe({
      next: (response: any) => {
